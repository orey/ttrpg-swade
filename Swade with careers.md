...
### Career Dice and Linked Attributes
- Careers use the same die types as SWADE skills (d4, d6, d8, d10, d12)
- Each career is linked to a primary attribute for advancement costs
- Starting characters get 12 points to distribute among careers
- Career advancement follows SWADE rules (cheaper when below attribute, expensive when above)
...
### **Psionicist** *(Linked to Spirit)* *(Science Fiction Career)*
...
### **Cybertech** *(Linked to Smarts)* *(Science Fiction Career)*
...
### **Pilot** *(Linked to Agility)* *(Science Fiction Career)*
...
### **Corporate** *(Linked to Spirit)* *(Science Fiction Career)*
...
- **Casting Roll**: Use Psionicist career die + Spirit

**Magic (Fantasy)**
- **Primary Career**: Scholar (academic magic) or Mystic (divine magic)
- **Power Points**: Based on primary spellcasting career
- **Casting Roll**: Use Scholar/Mystic career die + Spirit (Smarts for Scholar magic)
...
- **Casting Roll**: Use Artisan career die + Smarts
...
- **Natural Recovery**: 1 Power Point per hour of rest (standard SWADE rule)
- **Meditation**: Once per day, spend 10 minutes in deep focus and make a Psionicist career roll
  - **Success**: Recover 1 additional Power Point
  - **Raise**: Recover 2 additional Power Points
  - **Critical Failure**: Suffer level of Fatigue from mental strain (recovers normally)
- **Psionic Focus Items**: Artisan career to create/maintain focus crystals (+1 to casting rolls)
- **Mental Disciplines**: Characters with Mystic career can substitute it for Psionicist in meditation rolls, representing disciplined spiritual practices

### Untrained Power Use
- Characters without proper careers can attempt basic power use at d4-2
...
- New career starts at d4, linked to its primary attribute

### Career Advancement Costs
Follows standard SWADE advancement rules based on linked attribute:
- **Career die ≤ Attribute**: Normal cost (1 Advance)
- **Career die > Attribute**: Expensive (2 Advances)

*Example: Raising Warrior (Vigor-linked) from d6 to d8 costs 1 Advance if Vigor is d8+, but 2 Advances if Vigor is d6 or lower.*
...
### Cost per dice
- d4 = 1 point total
- d6 = 3 points total (you pay 1 for d4, then 2 more to reach d6)
- d8 = 6 points total (1+2+3)
- d10 = 10 points total (1+2+3+4)
- d12 = 15 points total (1+2+3+4+5)

### Starting archetypes with 12 points
- Focused Hero: **d10/d4/d4**, (10+1+1 = 12 points)
- Balanced Hero 1: **d6/d6/d6/d4/d4/d4** (3+3+3+1+1+1 = 12 points)
- Balanced Hero 2: **d6/d6/d6/d6** (3+3+3+3 = 12 points)
- Versatile Hero: **d8/d6/d4/d4/d4** (6+3+1+1+1 = 12 points)
